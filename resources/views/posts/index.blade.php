                   ...
                   class="relative block p-6 w-full bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 ">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">
                        ...
                        @elseif($post->status === "Progress")
                            <span style="color: #f6bf00" class="material-symbols-outlined weight-20 height-20">radio_button_checked</span>
                        @elseif($post->status === "Completed")
                            <span style="color: #5fdc3b" class="material-symbols-outlined weight-20 height-20">radio_button_checked</span>
                        @else
                            <span style="color: red" class="material-symbols-outlined weight-20 height-20">radio_button_checked</span>
                        @endif
                    </p>
                    </h5>
                    <p class="mb-2">
